...
tools: Read, Edit, Write, Grep, Glob, mcp__zai-vision__analyze_image, mcp__zai-vision__ui_diff_check, mcp__zai-vision__ui_to_artifact, mcp__zai-vision__analyze_data_visualization
model: inherit
---
