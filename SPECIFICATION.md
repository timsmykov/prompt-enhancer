...
- Настроить API‑ключ, модель и системный промпт в options.
...
- `overlay` UI: показывает прогресс/результат, кнопки Replace/Copy/Regenerate.
- `options` UI: ввод API‑ключа, модели, системного промпта.
